    ...
    public partial class initialmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuOfTheDays", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberInMenu = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "DishMenuOfTheDay",
                columns: table => new
                {
                    DishesId = table.Column<int>(type: "int", nullable: false),
                    MenuOfTheDaysId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishMenuOfTheDay", x => new { x.DishesId, x.MenuOfTheDaysId });
                    table.ForeignKey(
                        name: "FK_DishMenuOfTheDay_Dishes_DishesId",
                        column: x => x.DishesId,
                        principalTable: "Dishes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DishMenuOfTheDay_MenuOfTheDays_MenuOfTheDaysId",
                        column: x => x.MenuOfTheDaysId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ClassId = table.Column<int>(type: "int", nullable: false),
                    IsAllowedToUseAccount = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "DietaryRestrictionIngredient",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DietaryRestrictionIngredient", x => new { x.DietaryRestrictionsId, x.IngredientsId });
                    table.ForeignKey(
                        name: "FK_DietaryRestrictionIngredient_DietaryRestrictions_DietaryRestrictionsId",
                        column: x => x.DietaryRestrictionsId,
                        principalTable: "DietaryRestrictions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DietaryRestrictionIngredient_Ingredients_IngredientsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientInDishes", x => new { x.IngredientId, x.DishId });
                    table.ForeignKey(
                        name: "FK_IngredientInDishes_Dishes_DishId",
                        column: x => x.DishId,
                        principalTable: "Dishes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientInDishes_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DishPrice = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DietaryRestrictionIngredient_IngredientsId",
                table: "DietaryRestrictionIngredient",
                column: "IngredientsId");

            migrationBuilder.CreateIndex(
                name: "IX_DishMenuOfTheDay_MenuOfTheDaysId",
                table: "DishMenuOfTheDay",
                column: "MenuOfTheDaysId");

            migrationBuilder.CreateIndex(
                name: "IX_IngredientInDishes_DishId",
                table: "IngredientInDishes",
                column: "DishId");

            migrationBuilder.CreateIndex(
                name: "IX_Ingredients_CanteenId",
                table: "Ingredients",
                column: "CanteenId");

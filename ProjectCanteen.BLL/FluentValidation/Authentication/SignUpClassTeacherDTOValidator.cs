...
{
    public class SignUpClassTeacherDTOValidator : AbstractValidator<SignUpClassTeacherDTO>
    {
        public SignUpClassTeacherDTOValidator(IValidator<SignUpBaseDTO> validator)
        {
            Include(validator);
